export const translations = {
  en: {
    ...
    labels: {
      ...
      weightEntry: '{count} weight entry',
      weightEntries: '{count} weight entries',
      exerciseShort: 'ex',
      name: 'Name',
      weight: 'Weight',
      id: 'ID',
      ...
      exercise: 'Exercise',
      linkedExercise: 'Linked exercise',
      sets: 'Sets',
    ...
    program: {
      ...
      pdfImportTitle: 'Import plan PDF',
      pdfImportSummary: '{days} days imported • {exercises} exercises parsed',
    },
    placeholders: {
      email: 'Email',
      password: 'Password',
    ...
    trainers: {
      ...
      managementSubtitle: 'Register trainer accounts and keep the roster aligned.',
      managementHelp:
        'A trainer must already exist in Supabase Auth. Paste the auth user UUID and the display name you want to use in admin.',
      directoryTitle: 'Trainer directory',
      directorySubtitle: 'Rename or remove trainer accounts and review assignment load.',
      empty: 'No trainers found.',
      idLabel: 'Auth user ID',
      idPlaceholder: 'Supabase auth UUID',
      namePlaceholder: 'Trainer display name',
      createAction: 'Add trainer',
      createSaving: 'Creating trainer…',
      assignedCount: '{count} assigned trainees',
    },
    payment: {
    ...
    weightHistory: {
      ...
      subtitle: 'Track how the trainee weight changes over time.',
      addTitle: 'Add weight entry',
      addAction: 'Add weight',
      addSaving: 'Saving weight…',
      loading: 'Loading weight history…',
      empty: 'No weight history recorded yet.',
      summary: '{countLabel} • delta {delta}',
      chartAria: 'Weight history chart',
    },
    schedule: {
    ...
    errors: {
      ...
      deleteTrainee: 'Failed to delete trainee.',
      ...
      trainerIdRequired: 'Trainer auth user ID is required.',
      trainerIdInvalid: 'Trainer auth user ID must be a valid UUID.',
      trainerNameRequired: 'Trainer name is required.',
      createTrainer: 'Failed to create trainer.',
      updateTrainer: 'Failed to update trainer.',
      deleteTrainer: 'Failed to delete trainer.',
      ...
      loadFeedback: 'Failed to load feedback: {message}',
      loadPayments: 'Failed to load payments: {message}',
      pdfImportUnavailable: 'PDF importer is not available because PDF.js did not load.',
      pdfImportFailed: 'Failed to parse the PDF.',
      pdfWorkerUnavailable: 'PDF worker is not available. Check network connection.',
      ...
      emptyActivity: 'Add at least a name, note, or duration for the activity.',
      ...
      loadWeightLogs: 'Failed to load weight history.',
      addWeightLog: 'Failed to add weight entry.',
      deleteWeightLog: 'Failed to delete weight entry.',
      ...
      deleteMaxTest: 'Failed to delete max test.',
      coachTipUnavailable:
    ...
    confirm: {
      ...
      deleteTrainer:
        'Delete trainer "{name}" and remove {count} trainer assignments?',
      deletePlan: 'Delete this plan?',
      deleteDay: 'Delete this day and its exercises?',
  deleteDayExercise: 'Remove exercise from day?',
      deleteWeightLog: 'Delete this weight log entry?',
      deleteMaxTest: 'Delete this max test entry?',
      deleteTrainee: 'Delete trainee "{name}" and all related data?',
    },
    dayCodes: {
      A: 'A',
      B: 'B',
  ...
  it: {
    ...
    actions: {
      signIn: 'Accedi',
      signOut: 'Esci',
      backToTrainees: 'Torna agli allievi',
      save: 'Salva',
    ...
    labels: {
      ...
      weightEntry: '{count} rilevazione peso',
      weightEntries: '{count} rilevazioni peso',
      exerciseShort: 'es',
      name: 'Nome',
      weight: 'Peso',
      id: 'ID',
      ...
      activities: 'Attività',
      exercise: 'Esercizio',
      linkedExercise: 'Esercizio collegato',
      sets: 'Serie',
    ...
    program: {
      ...
      pdfImportTitle: 'Importa PDF programma',
      pdfImportSummary: '{days} giornate importate • {exercises} esercizi letti',
    },
    placeholders: {
      email: 'Email',
      password: 'Password',
    ...
    trainers: {
      ...
      idLabel: 'ID utente auth',
      idPlaceholder: 'UUID auth Supabase',
      namePlaceholder: 'Nome trainer',
      createAction: 'Aggiungi trainer',
      createSaving: 'Creazione trainer…',
      assignedCount: '{count} allievi assegnati',
    },
    payment: {
    ...
    status: {
      ...
      loadingTrainers: 'Caricamento trainer…',
      savingTrainer: 'Salvataggio trainer…',
    ...
    weightHistory: {
      ...
      subtitle: 'Monitora come cambia il peso dell’allievo nel tempo.',
      addTitle: 'Aggiungi rilevazione peso',
      addAction: 'Aggiungi peso',
      addSaving: 'Salvataggio peso…',
      loading: 'Caricamento storico peso…',
      empty: 'Nessuno storico peso registrato.',
      summary: '{countLabel} • delta {delta}',
      chartAria: 'Grafico storico peso',
    },
    schedule: {
    ...
    errors: {
      ...
      deleteTrainee: 'Impossibile eliminare l\'allievo.',
      ...
      trainerIdRequired: "L'ID auth del trainer è obbligatorio.",
      trainerIdInvalid: "L'ID auth del trainer deve essere un UUID valido.",
      trainerNameRequired: 'Il nome del trainer è obbligatorio.',
      createTrainer: 'Impossibile creare il trainer.',
      updateTrainer: 'Impossibile aggiornare il trainer.',
      deleteTrainer: 'Impossibile eliminare il trainer.',
      ...
      loadFeedback: 'Errore caricamento feedback: {message}',
      loadPayments: 'Errore caricamento pagamenti: {message}',
      pdfImportUnavailable: 'Importer PDF non disponibile: PDF.js non e stato caricato.',
      pdfImportFailed: 'Impossibile analizzare il PDF.',
      pdfWorkerUnavailable: 'Worker PDF non disponibile. Controlla la connessione.',
      ...
      emptyActivity: "Inserisci almeno nome, note o durata per l'attività.",
      ...
      loadWeightLogs: 'Impossibile caricare lo storico peso.',
      addWeightLog: 'Impossibile aggiungere la rilevazione peso.',
      deleteWeightLog: 'Impossibile eliminare la rilevazione peso.',
      ...
      deleteMaxTest: 'Impossibile eliminare il test massimale.',
      coachTipUnavailable:
    ...
    confirm: {
      ...
      deleteTrainer:
        'Eliminare il trainer "{name}" e rimuovere {count} assegnazioni trainer?',
   ...
   deleteDayExercise: "Rimuovere l'esercizio dalla giornata?",
      deleteWeightLog: 'Eliminare questa rilevazione peso?',
      deleteMaxTest: 'Eliminare questo test massimale?',
      deleteTrainee: 'Eliminare l\'allievo "{name}" e tutti i dati correlati?',
    },
    dayCodes: {
      A: 'A',
      B: 'B',
